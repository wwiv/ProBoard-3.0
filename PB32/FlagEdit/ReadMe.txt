========================================================================
		OLE Control DLL : FLAGEDIT
========================================================================

ControlWizard has created this project for your FLAGEDIT OLE Control DLL,
...
that make up your FLAGEDIT OLE Control DLL.
...
FlagEditCtl.h
	This file contains the declaration of the CFlagEditCtrl C++ class.

FlagEditCtl.cpp
	This file contains the implementation of the CFlagEditCtrl C++ class.

FlagEditPpg.h
	This file contains the declaration of the CFlagEditPropPage C++ class.

FlagEditPpg.cpp
	This file contains the implementation of the CFlagEditPropPage C++ class.

FlagEditCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CFlagEditCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file FlagEdit.rc.
